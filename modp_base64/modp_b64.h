...
* https://github.com/adobe/chromium/tree/master/third_party/modp_b64
*
...
inline std::string& Base64Encode( const std::string& sIn, std::string& sOut )
{
    sOut.clear();
    std::string x(modp_b64_encode_len(sIn.size()), '\0');
...
inline std::string& Base64Decode( const std::string& sIn, std::string& sOut )
{
    sOut.clear();
    std::string x(modp_b64_decode_len(sIn.size()), '\0');
